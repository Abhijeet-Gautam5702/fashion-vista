  ...
  return (
    <div className="w-full border-y-[1px] border-y-gray flex flex-row justify-start gap-3 py-2">
      ...
      <div className="w-fit flex-grow flex flex-col items-start justify-between">
        <p className="font-main font-500 text-text-col-2 text-size-15">
          {orderItem.product.name}
        </p>
        <div className="flex flex-row items-center justify-start">
          <ProductSizeBox
            sizeText={orderItem.size}
            className={`w-[30px] text-size-12 bg-white border-[1px] border-black-1 p-1`}
            disabled={true}
          />
          <ProductSizeBox
            sizeText={"x"}
            className={`w-[30px] text-size-12 p-1`}
            disabled={true}
          />
          <ProductSizeBox
            sizeText={orderItem.quantity}
            className={` text-size-12 p-1`}
            disabled={true}
          />
        </div>
      </div>
