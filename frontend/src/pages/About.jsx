...
function About() {
  ...
  return (
    <div className="border-y-[1.5px] border-y-gray py-10 w-full flex flex-col justify-start items-center gap-20">
      ...
      {/* Hero */}
      <div className="w-full flex flex-col lg:flex-row justify-start lg:justify-between items-center gap-16">
        {/* Image */}
        <div className="w-full lg:w-1/2 flex flex-row items-center justify-center flex-grow">
          <img
        ...
        {/* About Text */}
        <div className="w-full lg:w-1/2 flex flex-col justify-start items-start gap-6 font-main font-400 text-text-col-2 text-size-17">
          <p>
      ...
      <div className="w-full flex flex-col items-center justify-start gap-7 font-main">
        <p className="w-full text-center lg:text-left font-500 text-size-20 text-text-col-2">
          WHY DO WE STAND OUT?
        </p>
        <div className="w-full flex flex-col sm:flex-row justify-start sm:justify-between items-stretch">
          <div className=" w-full sm:w-1/3 border-[1px] px-10 py-12 md:py-8 sm:py-16 text-size-14 text-text-col-2 font-400 gap-3 border-gray flex flex-col items-center justify-start">
            <p className="w-full text-left font-500 text-black text-size-16">
              Quality Assurance
            </p>
            <p className="font-400 text-size-12">
              We meticulously select and vet each product to ensure it meets our
              stringent quality standards.
            </p>
          </div>
          <div className=" w-full sm:w-1/3 border-[1px] px-10 py-12 md:py-8 sm:py-16 text-size-14 text-text-col-2 font-400 gap-3 border-gray flex flex-col items-center justify-start">
            <p className="w-full text-left font-500 text-black text-size-16">Convenience</p>
            <p className="font-400 text-size-12">
          ...
          <div className=" w-full sm:w-1/3 border-[1px] px-10 py-12 md:py-8 sm:py-16 text-size-14 text-text-col-2 font-400 gap-3 border-gray flex flex-col items-center justify-start">
            <p className="w-full text-left font-500 text-black text-size-16">Customer Service</p>
            <p className="font-400 text-size-12">
